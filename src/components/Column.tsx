...
const mockTasks: TaskModel[] = [
  { id: "1", title: "Task 1", column: ColumnType.TO_DO, color: "red.300" },
  { id: "2", title: "Task 2", column: ColumnType.TO_DO, color: "blue.300" },
  { id: "3", title: "Task 3", column: ColumnType.TO_DO, color: "green.300" },
];
